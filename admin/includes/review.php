	...
	class WP_Review_Me {
		...
		protected function get_defaults() {
			...
			$defaults = array(
				...
				'slug'       => '',
				'rating'     => 5,
				'message'    => sprintf( esc_html__( 'Hey! It&#039;s been a little while that you&#039;ve been using this product. You might not realize it, but user reviews are such a great help to us. We would be so grateful if you could take a minute to leave a review on WordPress.org. Many thanks in advance :)', WFI_TEXTDOMAIN ) ),
				'link_label' => esc_html__( 'Click here to leave your review', WFI_TEXTDOMAIN ),
		...
		protected function maybe_prompt() {
			...
			dnh_register_notice(
                 $this->key, 'updated', $this->get_message(), array(
				'scope' => $this->scope,
				'cap'   => $this->cap,
			)
                );
